...
class Problema():	
    ...
    def name(self, nombre):## Retorna el nombre delproblema	
        self.nombre = nombre	
        return nombre	
        pass	
...
##                print("Hijo B: "+str(self.Hijo_B))
                ...
                listaPadres = []#Guarda los dos mejores fitness
                listaPadres.append(listaResulFitness.index(min(listaResulFitness)))
##                print("Listassss : \n")
##                print(listaResulFitness)
##                print(max(listaResulFitness))
                listaResulFitness.pop(listaResulFitness.index(min(listaResulFitness)))
                listaPadres.append(listaResulFitness.index(min(listaResulFitness)))
##                print(max(listaResulFitness))
##                print(listaPadres)
                Padre = []
...
##
##	print("\nRECUBRIMIENTO\n" )
##	stringInstrucciones = "genetico sp5.txt datosRecMin.txt 5 50 5 2 output.txt"
##	listaInstrucciones = stringInstrucciones.split()
##	print(listaInstrucciones)
##
##	pCantGeneraciones = int(listaInstrucciones[3])
